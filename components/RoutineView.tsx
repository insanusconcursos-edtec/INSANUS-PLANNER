...
import { Clock, User, Zap, BookOpen } from 'lucide-react';
...
const RoutineView: React.FC<RoutineViewProps> = ({ plans, routine, updateRoutine, onGeneratePlanning }) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="space-y-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-[10px] text-zinc-500">O perfil influencia o tempo estimado para concluir leituras e questões.</p>
          </div>
          ...
          >
            <Zap size={20} /> Iniciar / Replanejar Plano
          </button>
        </section>
